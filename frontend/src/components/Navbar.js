    ...
    <div className='bg-slate-300 py-3 '>
        <div className='flex justify-between items-center px-2  w-full md:w-[90%] mx-auto'>
            ...
            <div className='hidden md:flex justify-center items-center space-x-5 text-[15px] font-semibold text-slate-600'>
                ...
                <span className='cursor-pointer hover:text-black'>Sighn Up</span>
                <span className='bg-blue-300 px-3 py-1  rounded-sm'>Log In</span>
            </div>
            ...
            `}>
                ...
                <span className='hover:text-black cursor-pointer p-2 hover:bg-white '>Sighn Up</span>
                <span className='hover:text-black cursor-pointer p-2 hover:bg-white '>Log In</span>
            </div>
            {
