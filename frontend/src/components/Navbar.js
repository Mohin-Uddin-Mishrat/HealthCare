  ...
  return (
    <div className="bg-slate-300 py-3 ">
      <div className="flex justify-between items-center px-2  w-full md:w-[90%] mx-auto">
        ...
        <div className="hidden md:flex justify-center items-center space-x-5 text-[15px] font-semibold text-slate-600">
          ...
          { isAuthenticated ? (
            ...
            <>
              ...
              <Link to="/login" className="bg-blue-300 px-3 py-1  rounded-sm">
                Log In
              </Link>
            </>
          )}
        ...
        <div
          className={`fixed  top-[58px] right-0 p-6 flex flex-col  space-y-3 h-full ${
            isToggle ? "translate-x-0" : "translate-x-full"
          }   text-white font-semibold bg-slate-600 w-3/4
                    transition-transform duration-200 ease-in-out
            
            `}
        >
          <span className="hover:text-black cursor-pointer p-2 hover:bg-white ">
            Home
          </span>
          <span className="hover:text-black cursor-pointer p-2 hover:bg-white ">
            Contact Us
          ...
          <Link
            to="/register"
            className="hover:text-black cursor-pointer p-2 hover:bg-white "
          >
            Sighn Up
          </Link>
          <Link
